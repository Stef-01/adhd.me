// Vendored from iyinchao/liquid-glass-studio (MIT, Copyright (c) 2024 Charles Yin) — src/utils/GLUtils.ts,
// trimmed to the WebGL2 multi-pass renderer the app uses (no texture or video loaders). Founder,
// 2026-09-08: "install everything from its repo". The licence is beside this file.
