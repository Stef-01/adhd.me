              ...
              return (
                ...
                >
                  ...
                  <form action={stateInterest} className="mt-4 flex flex-wrap items-center gap-3">
                    ...
                    {/* O174: was 71x42 — two pixels under O14's floor, which is the size a
                        control reaches when nobody measures it. */}
                    <button
                      type="submit"
                      className="min-h-[44px] rounded-lg border border-stone-300 px-4 py-2 text-sm font-medium text-stone-800 hover:bg-stone-50"
                    >
                      Save
                    </button>
                  </form>
