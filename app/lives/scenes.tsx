...
const carton = <path d="M20 20l6-10h12l6 10v30a4 4 0 0 1-4 4H24a4 4 0 0 1-4-4z" fill="#fbfbfd" strokeLinejoin="round" />;

/** Every piece on a 64 by 64 stage. `lives-wing` groups flap under motion. */
const PIECES: Record<string, ReactElement> = {
  wasp: <><defs><mask id="wasp-mask"><rect width="64" height="64" fill="white" /><ellipse cx="36" cy="36" rx="8" ry="16" fill="black" transform="translate(-1, -2) scale(1.02)" /></mask></defs>
    <g className="lives-wing"><ellipse cx="26" cy="22" rx="6" ry="14" transform="rotate(-30 26 22)" fill="#f0f6fc" /><ellipse cx="26" cy="22" rx="4" ry="12" transform="rotate(-30 26 22)" fill="#ffffff" /></g>
    <g className="lives-wing is-right"><ellipse cx="42" cy="22" rx="6" ry="14" transform="rotate(30 42 22)" fill="#f0f6fc" /><ellipse cx="42" cy="22" rx="4" ry="12" transform="rotate(30 42 22)" fill="#ffffff" /></g>
    <path d="M36 36l-12 8m12-8l12 8M36 30l-14 4m14-4l14 4" stroke="#172033" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M36 18v-8" stroke="#172033" strokeWidth="2" strokeLinecap="round" fill="none" />
    <ellipse cx="36" cy="36" rx="8" ry="16" fill="#7d8494" />
    <ellipse cx="36" cy="36" rx="8" ry="16" fill="#000" fillOpacity="0.15" mask="url(#wasp-mask)" />
    <circle cx="36" cy="22" r="7" fill="#6679b9" />
    <circle cx="34" cy="21" r="2" fill="#172033" /><circle cx="38" cy="21" r="2" fill="#172033" />
  </>,
  bubble: <><defs><mask id="bubble-mask"><rect width="64" height="64" fill="white" /><circle cx="32" cy="32" r="20" fill="black" transform="translate(-2, -3) scale(1.02)" /></mask></defs><circle cx="32" cy="32" r="20" fill="#cfe3fb" fillOpacity="0.8" /><circle cx="32" cy="32" r="20" fill="#6679b9" fillOpacity="0.2" mask="url(#bubble-mask)" /><path d="M20 26q3-8 11-10" stroke="#fff" strokeWidth="4" strokeLinecap="round" fill="none" /></>,
  pancake: <><ellipse cx="32" cy="40" rx="24" ry="9" fill="#c8894a" /><ellipse cx="32" cy="34" rx="24" ry="9" fill="#e6b36a" /><path d="M22 30q10 6 20 0" fill="#f7de7a" /><rect x="27" y="24" width="10" height="7" rx="2" fill="#f7de7a" /></>,
  draft: <><path d="M10 14h44a4 4 0 0 1 4 4v22a4 4 0 0 1-4 4H26l-10 9v-9h-6a4 4 0 0 1-4-4V18a4 4 0 0 1 4-4z" fill="#5b8def" strokeLinejoin="round" /><path d="M18 24h28M18 32h20" stroke="#fff" strokeWidth="3.5" strokeLinecap="round" /></>,
  pigeon: <><g className="lives-wing"><path d="M30 34q10-18 26-12-8 8-20 16z" fill="#7d8494" strokeLinejoin="round" /></g><ellipse cx="34" cy="40" rx="17" ry="11" fill="#9aa0ad" /><circle cx="17" cy="32" r="8" fill="#7d8494" /><path d="M9 33l-6 2 6 2z" fill="#f2a33a" /><circle cx="15" cy="30" r="1.8" fill="#fff" /><path d="M28 51v6M38 51v6" stroke="#f2a33a" strokeWidth="3" strokeLinecap="round" /></>,
  seagull: <><g className="lives-wing"><path d="M30 34q10-18 26-12-8 8-20 16z" fill="#d7dce6" strokeLinejoin="round" /></g><ellipse cx="34" cy="40" rx="17" ry="11" fill="#fbfbfd" /><circle cx="17" cy="32" r="8" fill="#fbfbfd" /><path d="M8 33l-6 2 6 2z" fill="#f2c94c" /><circle cx="15" cy="30" r="1.8" fill={I} /><path d="M28 51v6M38 51v6" stroke="#f2a33a" strokeWidth="3" strokeLinecap="round" /></>,
  kayak: <><path d="M4 38q28-13 56 0q-28 14-56 0z" fill="#f2b44c" strokeLinejoin="round" /><path d="M9 38q23 6 46 0" stroke={I} strokeWidth="2" opacity=".35" fill="none" /><ellipse cx="32" cy="34" rx="10" ry="4" fill={I} /><path d="M11 20l42 28" stroke={I} strokeWidth="3" strokeLinecap="round" /><ellipse cx="11" cy="20" rx="4.5" ry="8" transform="rotate(-34 11 20)" fill="#5b8def" /><ellipse cx="53" cy="48" rx="4.5" ry="8" transform="rotate(-34 53 48)" fill="#5b8def" /><rect x="36" y="4" width="24" height="13" rx="3" fill="#e8625c" /><path d="M41 10.5h14" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" /></>,
  lamp: <><path d="M20 12h24l8 22H12z" fill="#f2d38a" strokeLinejoin="round" /><rect x="30" y="34" width="4" height="16" fill={I} /><rect x="18" y="50" width="28" height="5" rx="2" fill={I} /></>,
  cactus: <><rect x="20" y="42" width="24" height="14" rx="3" fill="#c8794a" /><path d="M32 42V14M32 30h-9v-9M32 26h9v-9" stroke="#6f9a63" strokeWidth="9" strokeLinecap="round" fill="none" /></>,
  drone: <><path d="M23 31l-11-9M41 31l11-9M23 41l-11 9M41 41l11 9" stroke={I} strokeWidth="3.5" strokeLinecap="round" /><ellipse cx="12" cy="21" rx="10" ry="3.5" fill="#cfd6e4" /><ellipse cx="52" cy="21" rx="10" ry="3.5" fill="#cfd6e4" /><ellipse cx="12" cy="51" rx="10" ry="3.5" fill="#cfd6e4" /><ellipse cx="52" cy="51" rx="10" ry="3.5" fill="#cfd6e4" /><rect x="21" y="27" width="22" height="16" rx="5" fill="#5b6475" /><circle cx="32" cy="35" r="2.5" fill="#5bd08a" /><circle cx="32" cy="47" r="4" fill={I} /></>,
  waffle: <><rect x="12" y="14" width="40" height="36" rx="6" fill="#e6b36a" /><path d="M12 26h40M12 38h40M24 14v36M40 14v36" stroke="#c8894a" strokeWidth="3" /></>,
  ...
  horse: <><rect x="18" y="30" width="30" height="16" rx="6" fill="#a8654a" /><path d="M44 30l6-12 6 4-4 10" fill="#a8654a" strokeLinejoin="round" /><path d="M22 46v10M42 46v10" stroke={I} strokeWidth="4" /><path d="M18 34l-6 8" stroke="#6f4a1a" strokeWidth="4" strokeLinecap="round" /></>,
  list: <>{paper}{lines}<path d="M19 28l3 3 5-6" stroke="#6f9a63" strokeWidth="3" fill="none" strokeLinecap="round" /></>,
  receipt: <><path d="M16 8h32v46l-4-4-4 4-4-4-4 4-4-4-4 4-4-4-4 4z" fill="#fbfbfd" strokeLinejoin="round" /><path d="M22 20h20M22 28h20M22 36h12" stroke="#8a90a0" strokeWidth="3" strokeLinecap="round" /><rect x="22" y="42" width="20" height="4" fill={I} /></>,
  leaflet: <><path d="M8 14l16-4v40L8 54zM24 10l16 4v40l-16-4zM40 14l16-4v40l-16 4z" fill="#fbfbfd" strokeLinejoin="round" /><rect x="28" y="20" width="8" height="10" fill="#e0616f" /></>,
  napkin: <><path d="M32 8l24 24-24 24L8 32z" fill="#fbfbfd" strokeLinejoin="round" /><path d="M32 8v48" stroke="#d7dce6" strokeWidth="2" /></>,
  menu: <>{paper}<path d="M16 8h26v10H16z" fill="#e0616f" />{lines}</>,
  cow: <><ellipse cx="34" cy="38" rx="20" ry="13" fill="#fbfbfd" /><circle cx="32" cy="34" r="5" fill={I} /><circle cx="44" cy="42" r="4" fill={I} /><circle cx="14" cy="30" r="9" fill="#fbfbfd" /><ellipse cx="12" cy="34" rx="5" ry="3" fill="#f2a6a6" /><path d="M22 50v6M44 50v6" stroke={I} strokeWidth="4" /></>,
  sheep: <><circle cx="22" cy="34" r="9" fill="#fbfbfd" /><circle cx="34" cy="28" r="10" fill="#fbfbfd" /><circle cx="44" cy="36" r="9" fill="#fbfbfd" /><circle cx="32" cy="42" r="10" fill="#fbfbfd" /><circle cx="14" cy="38" r="6" fill={I} /><path d="M24 50v6M40 50v6" stroke={I} strokeWidth="4" /></>,
  burger: <><path d="M12 28a20 12 0 0 1 40 0z" fill="#e6b36a" /><rect x="12" y="28" width="40" height="6" fill="#6f9a63" /><rect x="12" y="34" width="40" height="8" fill="#6f4a1a" /><path d="M12 42h40v6a4 4 0 0 1-4 4H16a4 4 0 0 1-4-4z" fill="#e6b36a" /></>,
  dinosaur: <><path d="M10 44q8-22 30-20l14-8-2 12 4 16H10z" fill="#6f9a63" strokeLinejoin="round" /><path d="M18 24l4-8 4 8 4-8 4 8" fill="#4c7a4a" /><path d="M20 44v10M40 44v10" stroke={I} strokeWidth="4" /><circle cx="48" cy="22" r="1.8" fill={I} /></>,
  spaceship: <><path d="M32 6q14 14 8 40H24Q18 20 32 6z" fill="#fbfbfd" strokeLinejoin="round" /><path d="M24 34l-8 12h8M40 34l8 12h-8" fill="#e0616f" /><circle cx="32" cy="24" r="4" fill="#5b8def" /><path d="M28 46l4 10 4-10" fill="#f2a33a" /></>,
  surfboard: <><path d="M32 4q16 28 0 56Q16 32 32 4z" fill="#4c9aa0" /><path d="M32 12v40" stroke="#fbfbfd" strokeWidth="3" /></>,
  brief: <><path d="M8 18h18l4 5h26v30H8z" fill="#f2c46b" strokeLinejoin="round" /><path d="M8 30h48" stroke={I} strokeWidth="3" /></>,
  report: <>{paper}<path d="M22 46V34M30 46V28M38 46V38M46 46V24" stroke="#5065a6" strokeWidth="4" strokeLinecap="round" /></>,
  slides: <><rect x="8" y="12" width="48" height="34" rx="4" fill="#fbfbfd" /><path d="M8 16a4 4 0 0 1 4-4h40a4 4 0 0 1 4 4v4H8z" fill="#5065a6" /><path d="M16 30h24M16 38h16" stroke="#8a90a0" strokeWidth="3" /><path d="M24 52h16" stroke={I} strokeWidth="3" /></>,
  ...
  roadmap: <><path d="M8 44q12-24 24-12t24-12" stroke="#5065a6" strokeWidth="4" fill="none" strokeLinecap="round" /><circle cx="8" cy="44" r="5" fill="#f2c46b" /><circle cx="32" cy="32" r="5" fill="#f2c46b" /><circle cx="56" cy="20" r="5" fill="#f2c46b" /></>,
  ...
  news: <><rect x="8" y="12" width="48" height="40" rx="3" fill="#fbfbfd" /><rect x="14" y="18" width="36" height="6" fill={I} /><rect x="14" y="28" width="16" height="16" fill="#8a90a0" /><path d="M34 30h16M34 36h16M34 42h16" stroke="#8a90a0" strokeWidth="2.5" /></>,
  shoes: <><path d="M6 40q10-14 22-4l12 4q8 2 8 8H6z" fill="#3b4a63" strokeLinejoin="round" /><path d="M12 40h34" stroke="#fbfbfd" strokeWidth="2" /><path d="M48 44h10v4H48z" fill={I} /></>,
  ...
  door: <><rect x="16" y="6" width="32" height="52" rx="3" fill="#8a6238" /><rect x="22" y="12" width="20" height="18" fill="#5a4029" /><rect x="22" y="34" width="20" height="18" fill="#5a4029" /><circle cx="42" cy="34" r="2.5" fill="#d9a441" /></>,
  laundry: <><path d="M10 26h44l-4 28H14z" fill="#8a90a0" strokeLinejoin="round" /><path d="M14 26q6-10 12-4t10 0 10 4 8 4" fill="#e0616f" /><path d="M18 26q8-8 14-2z" fill="#5b8def" /></>,
  plant: <><path d="M22 40h20l-3 16H25z" fill="#c8794a" strokeLinejoin="round" /><path d="M32 40V22M32 34q-14-2-14-16 14 0 14 16zM32 30q14-4 16-16-14-2-16 16z" fill="#6f9a63" stroke="#4c7a4a" /></>,
  drawer: <><rect x="8" y="14" width="48" height="40" rx="3" fill="#8a6238" /><rect x="14" y="30" width="36" height="16" fill="#5a4029" /><rect x="18" y="26" width="28" height="8" fill="#c8794a" /><rect x="28" y="36" width="8" height="3" fill="#d9a441" /></>,
  vacuum: <><path d="M20 50l20-30" stroke={I} strokeWidth="4" strokeLinecap="round" /><ellipse cx="18" cy="52" rx="14" ry="6" fill="#5b8def" /><rect x="24" y="30" width="20" height="16" rx="6" fill="#e0616f" /></>,
  hi: <><path d="M8 12h48v28H30l-10 10V40H8z" fill="#5b8def" strokeLinejoin="round" /><text x="32" y="33" fontSize="16" fontWeight="700" fill="#fff" textAnchor="middle" fontFamily="sans-serif">Hi</text></>,
  research: <><rect x="12" y="38" width="40" height="10" rx="2" fill="#5065a6" /><rect x="16" y="28" width="36" height="10" rx="2" fill="#e0616f" /><rect x="14" y="18" width="34" height="10" rx="2" fill="#4c9aa0" /><circle cx="48" cy="12" r="6" fill="none" stroke={I} strokeWidth="3" /><path d="M52 16l6 6" stroke={I} strokeWidth="3" /></>,
  notes: <><rect x="10" y="14" width="24" height="24" fill="#f2d38a" transform="rotate(-8 22 26)" /><rect x="28" y="20" width="24" height="24" fill="#a6d8c8" transform="rotate(6 40 32)" /><rect x="18" y="32" width="24" height="24" fill="#f2a6a6" /></>,
  bread: <><path d="M10 30a10 10 0 0 1 10-10h24a10 10 0 0 1 10 10v20H10z" fill="#e6b36a" /><path d="M20 28h24" stroke="#c8894a" strokeWidth="3" /></>,
  breadmaker: <><rect x="12" y="18" width="40" height="36" rx="5" fill="#8a90a0" /><rect x="20" y="10" width="24" height="10" rx="3" fill="#e6b36a" /><circle cx="32" cy="40" r="6" fill="#3b4a63" /></>,
  eggs: <><path d="M8 32h48v18H8z" fill="#d7dce6" /><ellipse cx="18" cy="32" rx="7" ry="9" fill="#fbfbfd" /><ellipse cx="32" cy="32" rx="7" ry="9" fill="#fbfbfd" /><ellipse cx="46" cy="32" rx="7" ry="9" fill="#fbfbfd" /></>,
  pizza: <><path d="M8 48a24 24 0 0 1 48 0z" fill="#8a6238" /><path d="M20 48a12 8 0 0 1 24 0z" fill={I} /><path d="M28 46q4-8 8 0z" fill="#f2a33a" /><rect x="6" y="48" width="52" height="8" fill="#5a4029" /></>,
  bagpipes: <><ellipse cx="30" cy="40" rx="16" ry="11" fill="#4c7a4a" /><path d="M22 32l-4-22M30 30l2-24M38 32l6-20M44 44l12 6" stroke="#8a6238" strokeWidth="5" strokeLinecap="round" /></>,
  bus: <><rect x="6" y="16" width="52" height="32" rx="6" fill="#f0b44a" /><path d="M12 22h12v12H12zM28 22h12v12H28zM44 22h8v12h-8z" fill="#cfe0f5" /><circle cx="18" cy="50" r="5" fill={I} /><circle cx="46" cy="50" r="5" fill={I} /></>,
  ...
  dog: <><rect x="14" y="28" width="30" height="16" rx="8" fill="#a8654a" /><circle cx="46" cy="28" r="9" fill="#a8654a" /><path d="M50 20l4-8-8 4z" fill="#6f4a1a" /><path d="M14 30l-8-8" stroke="#a8654a" strokeWidth="5" strokeLinecap="round" /><path d="M20 44v8M38 44v8" stroke={I} strokeWidth="4" /><circle cx="50" cy="27" r="1.8" fill={I} /></>,
  advert: <><rect x="6" y="10" width="52" height="34" rx="3" fill="#e0616f" /><path d="M14 20l12 6-12 6z" fill="#fbfbfd" /><path d="M32 20h18M32 28h18M32 36h10" stroke="#fbfbfd" strokeWidth="3" /><path d="M26 44v12M38 44v12" stroke={I} strokeWidth="4" /></>,
  roadworks: <><path d="M32 10l18 40H14z" fill="#f0b44a" strokeLinejoin="round" /><path d="M22 38h20M26 28h12" stroke="#fbfbfd" strokeWidth="5" /><rect x="8" y="50" width="48" height="6" rx="2" fill={I} /></>,
  thought: <><ellipse cx="34" cy="26" rx="22" ry="15" fill="#fbfbfd" /><circle cx="16" cy="46" r="5" fill="#fbfbfd" /><circle cx="8" cy="56" r="3" fill="#fbfbfd" /></>,
  printer: <><rect x="8" y="26" width="48" height="24" rx="4" fill="#8a90a0" /><rect x="18" y="12" width="28" height="14" fill="#fbfbfd" /><rect x="18" y="42" width="28" height="12" fill="#fbfbfd" /><circle cx="48" cy="34" r="2.5" fill="#6f9a63" /></>,
  colleague: <><path d="M32 8c16 0 24 12 24 28S48 62 32 62 8 52 8 36 16 8 32 8z" fill="#6c8cff" /><circle cx="25" cy="30" r="3" fill={I} /><circle cx="39" cy="30" r="3" fill={I} /><path d="M25 42q7 6 14 0" stroke={I} strokeWidth="3" fill="none" /></>,
  pen: <><path d="M12 52l6-18 26-26 12 12-26 26z" fill="#f2c46b" strokeLinejoin="round" /><path d="M18 34l12 12" stroke={I} strokeWidth="3" /><path d="M12 52l5-5" stroke={I} strokeWidth="5" /></>,
  glasses: <><circle cx="18" cy="34" r="11" fill="#cfe3fb" fillOpacity=".5" /><circle cx="46" cy="34" r="11" fill="#cfe3fb" fillOpacity=".5" /><path d="M29 34h6M7 30l-4-4M57 30l4-4" stroke={I} strokeWidth="3" /></>,
  font: <text x="32" y="44" fontSize="34" fontWeight="700" fill={I} textAnchor="middle" fontFamily="Georgia, serif">Aa</text>,
  question: <><ellipse cx="32" cy="28" rx="24" ry="18" fill="#fbfbfd" /><path d="M20 42l-6 12 16-8" fill="#fbfbfd" /><text x="32" y="36" fontSize="24" fontWeight="800" fill="#5065a6" textAnchor="middle" fontFamily="sans-serif">?</text></>,
  flights: <path d="M8 36l20-4 14-20 6 2-8 20 14 8-2 6-16-4-8 12-6-2 2-14-14-2z" fill="#fbfbfd" strokeLinejoin="round" />,
  podcast: <><path d="M12 40v-8a20 20 0 0 1 40 0v8" stroke={I} strokeWidth="4" fill="none" /><rect x="8" y="36" width="12" height="18" rx="4" fill="#5065a6" /><rect x="44" y="36" width="12" height="18" rx="4" fill="#5065a6" /></>,
  clock: <><circle cx="32" cy="32" r="22" fill="#fbfbfd" /><path d="M32 32V16M32 32l10 6" stroke={I} strokeWidth="3.5" strokeLinecap="round" /></>,
  parcel: <><rect x="10" y="18" width="44" height="36" rx="3" fill="#c8a06a" /><path d="M32 18v36M10 36h44" stroke="#8a6238" strokeWidth="4" /></>,
  stamp: <><rect x="12" y="12" width="40" height="40" fill="#fbfbfd" strokeDasharray="4 3" /><rect x="20" y="20" width="24" height="24" fill="#e0616f" /></>,
  duck: <><g className="lives-wing"><path d="M30 34q10-6 18 2-8 6-18 4z" fill="#e6b36a" /></g><ellipse cx="34" cy="40" rx="18" ry="11" fill="#f2c94c" /><circle cx="18" cy="28" r="9" fill="#f2c94c" /><path d="M9 29l-7 2 7 3z" fill="#f2a33a" /><circle cx="16" cy="26" r="1.8" fill={I} /></>,
  goose: <><path d="M22 42q-5-14 0-28" stroke={I} strokeWidth="13" strokeLinecap="round" fill="none" /><path d="M22 42q-5-14 0-28" stroke="#fbfbfd" strokeWidth="8" strokeLinecap="round" fill="none" /><ellipse cx="36" cy="42" rx="18" ry="11" fill="#fbfbfd" /><circle cx="22" cy="12" r="7" fill="#fbfbfd" /><path d="M14 13l-8 2 8 3z" fill="#f2a33a" /><circle cx="20" cy="10" r="1.8" fill={I} /><g className="lives-wing"><path d="M32 36q12-6 20 2-8 6-20 4z" fill="#d7dce6" /></g></>,
  tray: <><path d="M6 30h52l-6 20H12z" fill="#8a90a0" strokeLinejoin="round" /><path d="M6 30l-2-8h56l-2 8" fill="none" stroke={I} strokeWidth="3" /></>,
  plane: <><path d="M6 30l50-20-14 44-10-16z" fill="#fbfbfd" strokeLinejoin="round" /><path d="M32 38l24-28" stroke={I} strokeWidth="3" /></>,
  ...
  chair: <><path d="M20 8h24a4 4 0 0 1 4 4v20H16V12a4 4 0 0 1 4-4z" fill="#5b8def" /><rect x="11" y="32" width="42" height="9" rx="4" fill="#3b4a63" /><path d="M32 41v11M17 55l15-3 15 3" stroke={I} strokeWidth="3" strokeLinecap="round" fill="none" /><circle cx="17" cy="57" r="3.5" fill={I} /><circle cx="47" cy="57" r="3.5" fill={I} /><circle cx="32" cy="58" r="3.5" fill={I} /></>,
  lid: <><ellipse cx="32" cy="36" rx="24" ry="8" fill="#8a90a0" /><rect x="26" y="20" width="12" height="12" rx="3" fill="#3b4a63" /></>,
  cloud: <path d="M16 46a10 10 0 0 1 2-20 14 14 0 0 1 27-4 10 10 0 0 1 3 24z" fill="#fbfbfd" strokeLinejoin="round" />,
  thread: <><rect x="16" y="14" width="32" height="36" rx="4" fill="#5065a6" /><rect x="12" y="10" width="40" height="6" rx="2" fill="#8a6238" /><rect x="12" y="48" width="40" height="6" rx="2" fill="#8a6238" /><path d="M48 30q12 4 10 22" stroke="#5065a6" strokeWidth="3" fill="none" /></>,
  toast: <><path d="M14 26a10 10 0 0 1 10-10h16a10 10 0 0 1 10 10v28H14z" fill="#e6b36a" /><path d="M20 30a6 6 0 0 1 6-6h12a6 6 0 0 1 6 6v20H20z" fill="#f2d38a" /></>,
  cord: <><path d="M32 4v34" stroke={I} strokeWidth="3" /><circle cx="32" cy="44" r="8" fill="#f2c46b" /></>,
  towel: <><rect x="10" y="12" width="44" height="6" rx="3" fill="#8a90a0" /><path d="M16 18h32v32q-8 6-16 0t-16 0z" fill="#f2d38a" strokeLinejoin="round" /><path d="M16 30h32" stroke="#fbfbfd" strokeWidth="3" /></>,
  bell: <><path d="M20 40V28a12 12 0 0 1 24 0v12l4 6H16z" fill="#f2c46b" strokeLinejoin="round" /><path d="M28 50a4 4 0 0 0 8 0" stroke={I} strokeWidth="3" fill="none" /><circle cx="46" cy="18" r="6" fill="#e0616f" /></>,
  ...
  speech: <><path d="M8 12h48a4 4 0 0 1 4 4v22a4 4 0 0 1-4 4H30l-10 10V42H8a4 4 0 0 1-4-4V16a4 4 0 0 1 4-4z" fill="#fbfbfd" strokeLinejoin="round" /><path d="M16 24h32M16 32h20" stroke="#8a90a0" strokeWidth="3" strokeLinecap="round" /></>,
  note: <><path d="M12 10h40v34l-10 10H12z" fill="#f2d38a" strokeLinejoin="round" /><path d="M42 54V44h10" fill="none" stroke={I} strokeWidth="3" /><path d="M20 22h24M20 30h18" stroke="#8a90a0" strokeWidth="3" strokeLinecap="round" /></>,
};
...
const ART: Record<string, (s: SceneState) => ReactElement> = {
  ...
  crossing: ({ stake }) => <>
    <rect width="390" height="560" fill="var(--w1)" />
    <path d="M0 110V60h50v-20h40v40h40V50h60v30h40V40h50v50h50v-30h60v50z" fill="#000" opacity=".05" transform="translate(-4, 6)" />
    ...
    {[150, 210, 270, 330, 390, 450].map((y) => <rect key={`s-${y}`} x="30" y={y+4} width="330" height="26" rx="4" fill="#000" opacity=".05" />)}
    ...
    <rect x="22" y="24" width="8" height="70" fill="#000" opacity=".1" />
    <rect x="20" y="20" width="8" height="70" fill="var(--w7)" />
    <rect x="14" y="14" width="24" height="44" rx="6" fill="#000" opacity=".1" />
    <rect x="12" y="10" width="24" height="44" rx="6" fill="var(--w7)" />
    <circle cx="24" cy="22" r="6" fill={stake > 0.7 ? "#e0616f" : "var(--w4)"} /><circle cx="24" cy="40" r="6" fill={stake > 0.7 ? "var(--w4)" : "#6f9a63"} />
    
    <rect x="352" y="34" width="6" height="60" fill="#000" opacity=".1" />
    <rect x="350" y="30" width="6" height="60" fill="var(--w7)" />
    <rect x="338" y="28" width="34" height="34" rx="4" fill="#000" opacity=".1" />
    <rect x="336" y="24" width="34" height="34" rx="4" fill="var(--w6)" />
  </>,
  meeting: ({ game, stake }) => <>
    <rect width="390" height="560" fill="var(--w1)" />
    
    <rect x="274" y="44" width="100" height="130" rx="8" fill="#000" opacity=".05" />
    ...
    <rect x="64" y="44" width="180" height="120" rx="8" fill="#000" opacity=".05" />
    ...
    <rect x="44" y="334" width="60" height="70" rx="12" fill="#000" opacity=".05" />
    <rect x="294" y="334" width="60" height="70" rx="12" fill="#000" opacity=".05" />
    <rect x="40" y="330" width="60" height="70" rx="12" fill="var(--w3)" /><rect x="290" y="330" width="60" height="70" rx="12" fill="var(--w3)" />
    
    <path d="M0 400q195-40 390 0v160H0z" fill="#000" opacity=".05" transform="translate(0, 6)" />
    <path d="M0 400q195-40 390 0v160H0z" fill="var(--w2)" /><path d="M0 400q195-40 390 0" stroke="var(--w7)" strokeWidth="6" fill="none" />
    
    <rect x="304" y="434" width="30" height="34" rx="6" fill="#000" opacity=".05" />
    ...
    <path d="M60 470h110v-60H60z" fill="#000" opacity=".05" transform="translate(4, 4)" />
    ...
    {game === "zoe_keyword" && <g transform={`translate(${-140 + stake * 340} 0)`}><path d="M60 220h120a8 8 0 0 1 8 8v40a8 8 0 0 1-8 8H90l-12 12v-12H60a8 8 0 0 1-8-8v-40a8 8 0 0 1 8-8z" fill="var(--w5)" stroke="var(--w4)" /><path d="M72 244h90M72 260h60" stroke="var(--w3)" strokeWidth="6" strokeLinecap="round" /></g>}
  </>,
  phone: ({ game, stake }) => <>
    <rect width="390" height="560" fill="var(--w1)" />
    <rect x="22" y="4" width="354" height="560" rx="28" fill="#000" opacity=".05" />
    ...
    <rect x="18" y="40" width="354" height="60" fill="#000" opacity=".05" />
    <rect x="18" y="36" width="354" height="60" fill="var(--w5)" />
    <circle cx="60" cy="66" r="18" fill="var(--w3)" /><rect x="90" y="56" width="110" height="10" rx="4" fill="var(--w7)" /><rect x="90" y="72" width="60" height="8" rx="4" fill="var(--w4)" />
    
    {game === "zoe_dont_send" && <g transform={`translate(0 ${-stake * 60})`}>
      <rect x="42" y="124" width="180" height="40" rx="14" fill="#000" opacity=".05" />
      <rect x="40" y="120" width="180" height="40" rx="14" fill="var(--w4)" />
      <rect x="172" y="180" width="180" height="40" rx="14" fill="#000" opacity=".05" />
      <rect x="170" y="176" width="180" height="40" rx="14" fill="var(--w3)" />
      <rect x="42" y="236" width="140" height="40" rx="14" fill="#000" opacity=".05" />
      <rect x="40" y="232" width="140" height="40" rx="14" fill="var(--w4)" />
      <rect x="132" y="292" width="220" height="40" rx="14" fill="#000" opacity=".05" />
      <rect x="130" y="288" width="220" height="40" rx="14" fill="var(--w3)" />
      
      <rect x="36" y="348" width="322" height="76" rx="14" fill="#000" opacity=".05" />
      <rect x="34" y="344" width="322" height="76" rx="14" fill="var(--w5)" /><path d="M50 366h200M50 386h150M50 404h120" stroke="var(--w4)" strokeWidth="6" strokeLinecap="round" />
    </g>}
    ...
    {[440, 478, 516].map((y, row) => Array.from({ length: 10 - row }, (_, i) => <rect key={`sh-${y}-${i}`} x={32 + row * 17 + i * 34} y={y+2} width="28" height="30" rx="5" fill="#000" opacity=".05" />))}
  ...
  hall: ({ stake }) => <>
    ...
    <rect x="240" y="74" width="134" height="332" rx="4" fill="#000" opacity=".05" />
    <rect x="236" y="70" width="134" height="332" rx="4" fill="var(--w3)" />
    
    <rect x="252" y="90" width="102" height="120" rx="3" fill="var(--w4)" /><rect x="252" y="230" width="102" height="150" rx="3" fill="var(--w4)" /><circle cx="262" cy="240" r="7" fill="var(--w6)" />
    
    <rect x="230" y="408" width="154" height="20" rx="4" fill="#000" opacity=".05" />
    <rect x="226" y="404" width="154" height="20" rx="4" fill="var(--w4)" />
    
    <rect x="34" y="124" width="150" height="10" rx="4" fill="#000" opacity=".05" />
    ...
    <rect x="28" y="294" width="170" height="10" rx="3" fill="#000" opacity=".05" />
    <rect x="24" y="290" width="170" height="10" rx="3" fill="var(--w3)" /><path d="M60 290a20 10 0 0 1 40 0z" fill="var(--w5)" />
    
    <circle cx="194" cy="64" r="34" fill="#000" opacity=".05" />
    <circle cx="190" cy="60" r="34" fill="var(--w5)" /><path d="M190 60V38" stroke="var(--w7)" strokeWidth="4" strokeLinecap="round" transform={`rotate(${stake * 300} 190 60)`} /><path d="M190 60l14 8" stroke="var(--w7)" strokeWidth="4" strokeLinecap="round" />
  </>,
  bathroom: ({ stake }) => <>
    <rect width="390" height="560" fill="var(--w1)" />
