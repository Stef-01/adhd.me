...
const PIECES: Record<string, ReactElement> = {
  ...
  kayak: <><path d="M4 38q28-13 56 0q-28 14-56 0z" fill="#f2b44c" stroke={I} strokeWidth="3" strokeLinejoin="round" /><path d="M9 38q23 6 46 0" stroke={I} strokeWidth="2" opacity=".35" fill="none" /><ellipse cx="32" cy="34" rx="10" ry="4" fill={I} /><path d="M11 20l42 28" stroke={I} strokeWidth="3" strokeLinecap="round" /><ellipse cx="11" cy="20" rx="4.5" ry="8" transform="rotate(-34 11 20)" fill="#5b8def" stroke={I} strokeWidth="2.5" /><ellipse cx="53" cy="48" rx="4.5" ry="8" transform="rotate(-34 53 48)" fill="#5b8def" stroke={I} strokeWidth="2.5" /><rect x="36" y="4" width="24" height="13" rx="3" fill="#e8625c" stroke={I} strokeWidth="2.5" /><path d="M41 10.5h14" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" /></>,
  ...
  drone: <><path d="M23 31l-11-9M41 31l11-9M23 41l-11 9M41 41l11 9" stroke={I} strokeWidth="3.5" strokeLinecap="round" /><ellipse cx="12" cy="21" rx="10" ry="3.5" fill="#cfd6e4" stroke={I} strokeWidth="2" /><ellipse cx="52" cy="21" rx="10" ry="3.5" fill="#cfd6e4" stroke={I} strokeWidth="2" /><ellipse cx="12" cy="51" rx="10" ry="3.5" fill="#cfd6e4" stroke={I} strokeWidth="2" /><ellipse cx="52" cy="51" rx="10" ry="3.5" fill="#cfd6e4" stroke={I} strokeWidth="2" /><rect x="21" y="27" width="22" height="16" rx="5" fill="#5b6475" stroke={I} strokeWidth="3" /><circle cx="32" cy="35" r="2.5" fill="#5bd08a" /><circle cx="32" cy="47" r="4" fill={I} /></>,
  ...
  chair: <><path d="M20 8h24a4 4 0 0 1 4 4v20H16V12a4 4 0 0 1 4-4z" fill="#5b8def" stroke={I} strokeWidth="3" /><rect x="11" y="32" width="42" height="9" rx="4" fill="#3b4a63" stroke={I} strokeWidth="3" /><path d="M32 41v11M17 55l15-3 15 3" stroke={I} strokeWidth="3" strokeLinecap="round" fill="none" /><circle cx="17" cy="57" r="3.5" fill={I} /><circle cx="47" cy="57" r="3.5" fill={I} /><circle cx="32" cy="58" r="3.5" fill={I} /></>,
