  ...
  return <main id="main-content" className={`meditation-studio${session ? " is-playing" : ""}`}>
    ...
    <AnimatePresence mode="wait" initial={false}>
      {!session ? <motion.div key="lobby" className="meditation-lobby" initial={reduced ? false : { opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
        <div className="meditation-invitation"><span className="activity-label">A GUIDED MOMENT OF STILLNESS</span><MeditationTitle focus={hasStarted}>A little less doing.<br />A little more being.</MeditationTitle><p>Sit comfortably. Follow the prompts.</p>
