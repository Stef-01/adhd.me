...
function PropArt({ prop }: { prop: Prop }) {
  switch (prop) {
    ...
    case "phone": return <><rect x="236" y="40" width="74" height="140" rx="14" fill="#7c8fc4" /><rect x="244" y="52" width="58" height="108" rx="6" fill="#dfe9ff" /><circle cx="273" cy="170" r="5" fill="#dfe9ff" /><circle cx="256" cy="72" r="8" fill="#ff6b57" /><rect x="270" y="66" width="24" height="5" rx="2" fill="#8fa5d6" /><rect x="270" y="75" width="18" height="5" rx="2" fill="#8fa5d6" /></>;
    ...
    case "lecture": return <><rect x="176" y="40" width="168" height="100" rx="8" fill="#5b8a6a" /><rect x="184" y="48" width="152" height="84" rx="4" fill="#6fa383" /><rect x="200" y="66" width="90" height="6" rx="3" fill="#dff0e6" opacity=".8" /><rect x="200" y="82" width="120" height="6" rx="3" fill="#dff0e6" opacity=".6" /><rect x="200" y="98" width="70" height="6" rx="3" fill="#dff0e6" opacity=".6" /><rect x="252" y="140" width="16" height="44" fill="#c9bfae" /></>;
    ...
    case "door": return <><rect x="232" y="30" width="96" height="158" rx="6" fill="#b08a6e" /><rect x="242" y="40" width="76" height="140" rx="4" fill="#c9a585" /><rect x="252" y="52" width="56" height="52" rx="3" fill="#b28e6c" /><rect x="252" y="112" width="56" height="58" rx="3" fill="#b28e6c" /><circle cx="304" cy="112" r="5" fill="#f0d9a8" /></>;
