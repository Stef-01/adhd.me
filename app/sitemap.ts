...
// itself in the sitemap is not hidden — it is hidden from readers and announced to crawlers.
const PUBLIC_PATHS = ["/", ...(TEAM_PAGE_PUBLIC ? ["/about"] : []), "/finder", "/approach", "/examples", "/faq", "/practices", "/clinicians", "/clinicians/join", "/privacy", "/privacy/automated-decisions", "/privacy/counsel-review", "/terms", "/thanks"];
