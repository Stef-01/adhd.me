 ...
 *  reason that has nothing to do with the matcher improving, so a flat rate here means the new
 *  sentences are about as separable as the old ones rather than that nothing happened);
