...
export const CHARACTERS: readonly LivesCharacter[] = [
  ...
  { id: "arjun", name: "Arjun", hook: "Runs the numbers for the whole company. Loses the meeting to a cow.", pattern: "High achievement, wandering attention, deep focus", mechanics: ["tap_filter", "sequence"], domains: ["attention", "working_memory", "prioritisation"], trying: ["meeting_anchor", "parking_lot_note"], moment: "Where did my attention go?" },
  { id: "zoe", name: "Zoe", hook: "Says the thing. Then the next thing. Then fourteen things.", pattern: "Impulsivity and quick feeling", mechanics: ["no_input", "hold", "tap"], domains: ["impulsivity", "communication", "relationships", "emotional_regulation"], trying: ["pause_before_send", "hold_the_keyword"], moment: "Ever wanted to reply immediately and regretted it?" },
  ...
  { id: "jax", name: "Jax", hook: "Went out for milk. Came back with a kayak.", pattern: "Novelty and impulse", mechanics: ["swipe", "tap"], domains: ["impulsivity", "prioritisation", "planning"], trying: ["park_the_idea", "pause_before_send"], moment: "Just milk. Just. Milk." },
  { id: "nina", name: "Nina", hook: "Can write the perfect email. Has been about to start it since Tuesday.", pattern: "Starting and perfectionism", mechanics: ["tap", "no_input"], domains: ["task_initiation", "emotional_regulation", "planning", "self_understanding"], trying: ["sixty_second_start", "imperfect_first_draft"], moment: "The task became a mountain before it began." },
];
