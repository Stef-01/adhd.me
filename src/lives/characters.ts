...
export const CHARACTERS: readonly LivesCharacter[] = [
  { id: "maya", name: "Maya", hook: "Can find her way through a spreadsheet. Cannot find her way across a busy intersection.", pattern: "Distractibility and overwhelm", mechanics: ["trace", "tap_filter", "tap"], domains: ["sensory_management", "environment", "planning", "transitions", "mindfulness"], trying: ["lower_sensory_floor", "overwhelm_reset", "transition_reset", "brain_everywhere"], moment: "Everything at the crossing was loud at once." },
  { id: "leo", name: "Leo", hook: "Falls asleep anywhere except in bed.", pattern: "Restlessness and sensory intensity", mechanics: ["tap", "catch", "rapid_tap"], domains: ["sleep", "sensory_management", "mindfulness"], trying: ["lower_sensory_floor", "sleep_wind_down", "brain_dump_bed", "brain_everywhere"], moment: "Why is that tiny sound SO loud?" },
  ...
  { id: "zoe", name: "Zoe", hook: "Says the thing. Then the next thing. Then fourteen things.", pattern: "Impulsivity and quick feeling", mechanics: ["no_input", "hold", "tap"], domains: ["impulsivity", "communication", "relationships", "emotional_regulation"], trying: ["pause_before_send", "hold_the_keyword", "park_the_idea", "hard_conversation"], moment: "Ever wanted to reply immediately and regretted it?" },
  { id: "theo", name: "Theo", hook: "Can estimate the economic impact of a project. Cannot estimate how long a shower takes.", pattern: "Time blindness and transitions", mechanics: ["sequence", "tap_filter", "trace"], domains: ["time_management", "transitions", "planning", "environment"], trying: ["reverse_planning", "launch_pad", "transition_reset", "sixty_second_reset"], moment: "It was 7:55 and the bookshelf needed reorganising." },
  ...
  { id: "jax", name: "Jax", hook: "Went out for milk. Came back with a kayak.", pattern: "Novelty and impulse", mechanics: ["swipe", "tap"], domains: ["impulsivity", "prioritisation", "planning"], trying: ["park_the_idea", "pause_before_send", "external_cue", "hard_conversation"], moment: "Just milk. Just. Milk." },
  { id: "nina", name: "Nina", hook: "Can write the perfect email. Has been about to start it since Tuesday.", pattern: "Starting and perfectionism", mechanics: ["tap", "no_input"], domains: ["task_initiation", "emotional_regulation", "planning", "self_understanding"], trying: ["sixty_second_start", "imperfect_first_draft", "reverse_planning", "sixty_second_reset"], moment: "The task became a mountain before it began." },
];
