...
export const INTERACTIVE_MODULES: readonly InteractiveModule[] = [
  ...
  // ── Added 2026-09-08 (founder: eating, the gut, and more; PLAY-PLAN.md §12) ──────────────
  {
    id: "eating",
    title: "Forgot to eat again",
    subtitle: "Why hunger arrives late, and how to eat before it does",
    minutes: 6,
    domain: "sleep-body",
    ...
    steps: [
      ...
      { kind: "choice", who: "priya", mood: "thinking", prop: "kitchen", heading: "Why did lunch not happen?", options: [
        { id: "busy", label: "Too busy", response: "Partly. But busy people with a loud hunger signal still eat. Priya’s signal is quiet." },
        { id: "signal", label: "She did not feel hungry", response: "Yes. Many people with ADHD notice hunger late, the body says it quietly, and the brain is elsewhere." },
      ...
      { kind: "strategy", heading: "Anchor food to things that already happen.", body: "The kettle, the first meeting, the walk to the car. The anchor remembers so you do not have to.", strategies: [
        { id: "meal-anchors", title: "Meal anchors", acts: "environment", steps: ["Pick two things that happen every day, the first coffee, the 1pm calendar gap, and put food beside them", "Set one alarm labelled ‘eat something’, not ‘lunch’", "Keep two no-cook foods within arm’s reach of where you work"] },
        { id: "protein-first", title: "Something with protein, early", acts: "body", steps: ["Put one protein food where the morning coffee is made", "Eat it with the coffee, before the day starts pulling"] },
      ] },
      { kind: "insight", id: "eating-quiet-signal", heading: "Hunger reaches you late, so food has to be planned, not felt.", body: "That is not a discipline problem. It is a signal problem, and signals can be replaced with anchors.", byAnswer: { question: "misses", map: { "deep-work": "Deep work is where lunch vanishes; an alarm and food on the desk are the fix.", medication: "Medication days need food planned before the day starts.", evening: "A day with nothing in it ends with everything at nine. Earlier food is the lever." } } },
      { kind: "next", heading: "Put two no-cook foods beside where you work, tonight.", body: "If a day of nothing keeps ending in an evening of everything, a GP or a dietitian is the person to describe that to.", action: "try" },
    ],
  },
  {
    id: "gut",
    title: "The gut and the brain",
    subtitle: "A two-way lane, and the plain habits that help both ends",
    minutes: 6,
    domain: "sleep-body",
    ...
    steps: [
      ...
      { kind: "choice", who: "jordan", mood: "thinking", prop: "kitchen", heading: "Is the gut the cause or the effect?", options: [
        { id: "cause", label: "The cause", response: "Not established. Research into the gut and ADHD is early, and there is no single gut signature for ADHD." },
        { id: "effect", label: "The effect", response: "Partly. A chaotic week, skipped meals, little sleep, a lot of stress, shows up in the gut fast." },
      ...
      { kind: "strategy", heading: "The plain four, made visible.", body: "Water, one fibre thing, a regular-ish meal, a walk after it. Not a diet. Four anchors.", strategies: [
        { id: "plain-four", title: "The plain four", acts: "body", steps: ["A water bottle on the desk, filled with the first coffee", "One fibre food you already like, put where you will see it", "Ten minutes on foot after one meal a day"] },
      ] },
      { kind: "insight", id: "gut-two-way", heading: "Your gut goes first on a hard week, and the plain routine steadies both ends.", body: "Not a supplement, not a diet, four visible anchors that survive a bad week.", byAnswer: { question: "pattern", map: { skips: "Meals vanishing is the lever: the eating run is the pair to this one.", water: "Water in reach is the smallest anchor and the most often missed.", takeaway: "Takeaway is fine; the fibre thing beside it is the change." } } },
      { kind: "next", heading: "Fill a bottle and put it where you work, now.", body: "If the stomach is unhappy most weeks, that is a conversation for a GP, not an app.", action: "try" },
    ],
  },
  {
    id: "money",
    title: "Where did the money go",
    subtitle: "Impulse, forgotten subscriptions, and the late-fee tax",
    minutes: 6,
    domain: "daily-life",
    targets: ["inhibition", "memory", "time"],
    strength: "Once a bill pays itself it stays paid, you built that once and it holds",
    characters: ["alex", "sam"],
    professions: ["adhd-coach", "occupational-therapist"],
    steps: [
      ...
      { kind: "strategy", heading: "Make the pause long and the bills automatic.", body: "A day between wanting and buying. Bills that pay themselves. A list of what charges you.", strategies: [
        { id: "day-pause", title: "The one-day pause", acts: "brain", steps: ["Put things you want in a list, not a cart, and buy from the list a day later", "Take saved cards off the phone so buying takes a minute, not a tap"] },
        { id: "autopay", title: "Bills that pay themselves", acts: "environment", steps: ["Set the two most-missed bills to pay automatically", "Write every subscription on one visible list, and cancel one this week"] },
      ] },
      { kind: "insight", id: "money-out-of-sight", heading: "Money goes to what is out of sight and to what is one tap away.", body: "So bring it into sight, and put a day between you and the tap.", byAnswer: { question: "leak", map: { subs: "A visible list of what charges you is the whole fix for subscriptions.", fees: "A bill that pays itself never gets a late fee.", impulse: "The one-day list is built for late-night buying." } } },
      { kind: "next", heading: "Write every subscription on one list, tonight.", body: "If money keeps going somewhere you did not choose, a coach or an occupational therapist can build the structure with you.", action: "try" },
    ],
  },
  {
    id: "mornings",
    title: "Out the door",
    subtitle: "Why mornings run late, and the launchpad that fixes half of it",
    minutes: 6,
    domain: "daily-life",
    targets: ["time", "memory", "activation", "structure"],
    strength: "On the mornings the bag is packed, you leave on time without thinking about it",
    characters: ["jordan", "sam"],
    professions: ["adhd-coach", "occupational-therapist"],
    steps: [
      { kind: "scene", stage: "hook", who: "jordan", mood: "overwhelmed", prop: "door", eyebrow: "8:52am", heading: "Keys, phone, charger, the form. One of them is always missing.", body: "Jordan is standing at the door for the third time. The bus is at 8:55. The form for work is on the kitchen table, under the bowl." },
      { kind: "choice", who: "jordan", mood: "anxious", prop: "door", heading: "Why is the last five minutes always chaos?", options: [
        { id: "early", label: "Not getting up early enough", response: "Getting up earlier moves the chaos earlier. The chaos is made of decisions, not minutes." },
        { id: "decisions", label: "Too many decisions at once", response: "Yes. Keys, charger, form, jacket: each is a working-memory item, all due at once, at the door." },
      ...
      { kind: "strategy", heading: "A launchpad, and a leave-time alarm.", body: "One spot by the door. Everything for tomorrow goes there tonight. One alarm that means ‘walk out’, not ‘get ready’.", strategies: [
        { id: "launchpad", title: "The launchpad", acts: "environment", steps: ["Pick one spot by the door, a hook, a tray, a shelf", "Tonight, put tomorrow’s keys, bag and papers there", "Set an alarm that means ‘leave now’, five minutes before you need to"] },
      ] },
      { kind: "insight", id: "mornings-launchpad", heading: "The morning is a memory test, and the launchpad takes the test for you.", body: "Decide at night, leave on an alarm. The door stops being where things go wrong.", byAnswer: { question: "leave", map: { feel: "Feeling late is the time-sense trap; the leave alarm replaces it.", alarm: "You already have the alarm; the launchpad is the other half." } } },
      { kind: "next", heading: "Choose the launchpad spot and put tomorrow’s keys there tonight.", body: "If mornings stay chaotic with the launchpad in place, a coach or an occupational therapist can look at the whole routine.", action: "try" },
    ],
  },
  {
    id: "screens",
    title: "The scroll at midnight",
    subtitle: "Why the phone wins at night, and how to make it lose",
    minutes: 6,
    domain: "sleep-body",
    targets: ["attention", "inhibition", "sleep"],
    strength: "On the nights the phone charges in the kitchen, you sleep an hour earlier without trying",
    characters: ["alex", "priya"],
    professions: ["psychologist", "gp"],
    steps: [
      { kind: "scene", stage: "hook", who: "alex", mood: "engaged", prop: "bed", eyebrow: "12:40am", heading: "One more video. Alex has said that eleven times.", body: "The phone is inches away, the feed never ends, and every clip is exactly as long as the pause between wanting to stop and stopping." },
      { kind: "choice", who: "alex", mood: "thinking", prop: "phone", heading: "Why does the scroll win?", options: [
        { id: "weak", label: "Weak willpower", response: "The feed is built by thousands of people to beat willpower. Losing to it is the design working." },
        { id: "pause", label: "The pause is too short", response: "Yes. The gap between ‘I should stop’ and stopping is exactly the length of one more clip." },
      ...
      { kind: "strategy", heading: "Distance, and something that ends.", body: "The charger in the kitchen. A book, a podcast episode, anything with an end.", strategies: [
        { id: "phone-in-kitchen", title: "The charger in the kitchen", acts: "environment", steps: ["Move the phone charger to the kitchen tonight", "Borrow or buy an alarm clock so the phone has no reason to be in the bedroom", "Leave one thing with an ending by the bed, a chapter, an episode"] },
      ] },
      { kind: "insight", id: "screens-distance", heading: "The feed beats willpower by design; distance beats the feed.", body: "You do not need a stronger pause. You need the phone further away than the pause is long.", byAnswer: { question: "where", map: { bed: "In the bed, the feed always wins. The kitchen charger is the whole change.", beside: "Beside the bed is one reach away; the kitchen is one decision away." } } },
      { kind: "next", heading: "Move the charger to the kitchen tonight.", body: "If nights stay late whatever the phone does, the sleep run is the pair to this one.", action: "learn", moduleId: "sleep" },
    ],
  },
];
