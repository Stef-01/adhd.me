...
export const ADJUSTMENT_TRACKS: readonly AdjustmentEntry[] = [
  {
    ...
    commonlyAvailable: [
      "Extensions on assignments without a fresh case each time",
      "Extra time and a quieter room in exams",
      "Permission to record lectures, or lecture notes provided",
      "Assignment briefs in writing with a clear definition of done",
      "A reduced study load without losing full-time status for some purposes",
  ...
  },
  {
    ...
    commonlyAvailable: [
      "Tasks and briefs in writing, with a definition of done",
      "One weekly check-in instead of scattered requests",
      "A quieter desk, noise-cancelling headphones, or set days at home",
      "Deadlines broken into milestones somebody is waiting for",
      "Meeting notes or a recording, so nothing lives only in working memory",
