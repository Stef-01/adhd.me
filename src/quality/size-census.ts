...
export const RATCHET: readonly RatchetEntry[] = [
  ...
  { measure: 'app-lines', value: 15752, on: SET_BY_O230, reason: "O230's shell components and the reasoning in them; the story landing kept every line it had, at a new address." },
  ...
  { measure: 'src-lines', value: 53602, on: SET_BY_O230, reason: "O230's tab register and the register edits the move required (robots, public surfaces, route weights)." },
  ...
  { measure: 'src-unreached-lines', value: 23297, on: SET_BY_O230, reason: 'O230: incidental — comment lines added to registers the product does not import.' },
  ...
  { measure: 'css-lines', value: 7935, on: SET_BY_O230, reason: 'O230: the tab bar and the sheet, written from the existing tokens with their reasoning beside them; the dead .quiet-link and .finder-home-link rules came out in the same pass.' },
  ...
  { measure: 'vitest-lines', value: 52923, on: SET_BY_O230, reason: 'O230: as vitest-files, plus the register edits the move required.' },
  ...
  { measure: 'e2e-spec-lines', value: 7683, on: SET_BY_O230, reason: 'O230: as e2e-spec-files.' },
