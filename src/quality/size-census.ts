...
export const RATCHET: readonly RatchetEntry[] = [
  ...
  { measure: 'src-unreached-lines', value: 24106, on: SET_BY_O249, reason: "O249: the history hook's direction and its comment — reached by the finder, counted here by the register's own rule." },
