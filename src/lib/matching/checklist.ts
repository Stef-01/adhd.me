...
export const CHECKLIST_TEMPLATES: readonly ChecklistTemplate[] = [
  ...
  {
    id: "symptom-timeline",
    label: "A symptom timeline, using the template on this page",
    why: "When things started, what changed, and what it costs you now is the first thing a GP asks; writing it down beforehand means you are not reconstructing it in the room.",
    required: true,
    triggers: [],
  },
  {
    id: "medication-list",
    label: "A list of every medication and supplement you take now",
  ...
  {
    id: "school-reports",
    label: "School reports from primary school, if they can be found",
  ...
  },
  {
    ...
    label: "A parent, older sibling or long-time friend willing to fill in a short questionnaire",
    why: "For adults, someone who knew you as a child can describe what they saw, which supports the timeline.",
    required: false,
    triggers: [{ id: "adult", when: (p) => isAdult(p) && !p.structuredSignals.priorAssessment }],
  },
  {
    id: "parent-and-teacher-questionnaires",
    label: "Parent and teacher questionnaires, which the GP will send before the visit",
    why: "For children and teenagers, a picture from home and from school is part of every assessment.",
    required: false,
    triggers: [{ id: "child", when: (p) => isChild(p) }],
  },
  {
    id: "prior-assessment-report",
    label: "The report or letter from your earlier assessment",
  ...
  },
  {
    ...
    label: "Names, doses and dates of ADHD medication you have taken, and how each went",
  ...
  },
  {
    ...
    label: "Letters or reports from any psychologist, psychiatrist or paediatrician involved",
  ...
  },
  {
    ...
    label: "An honest note of alcohol and other drug use",
    why: "It changes which medications can be started safely. GPs ask everyone; writing it down first makes the conversation easier.",
    required: false,
    triggers: [{ id: "substance", when: (p, c) => c.has("substance") || p.structuredSignals.comorbidities.includes("substance-history") }],
  },
  {
    id: "heart-history",
    label: "Any family history of heart problems, and your last BP reading if you know it",
    why: "Stimulant medication is not started without a heart check, so having this ready avoids a second visit for it.",
    required: false,
    triggers: [
  ...
  {
    id: "sleep-notes",
    label: "A week of sleep notes: bedtime, wake time, how rested you felt",
    why: "Sleep and attention pull on each other, and a week of notes is worth more than a guess in the room.",
    required: false,
    triggers: [{ id: "sleep", when: (_p, c) => c.has("sleep") }],
  },
  {
    id: "concession-card",
    label: "Your concession or health care card, and a question for the practice about bulk-billing",
    why: "The rebate and any gap depend on it, and asking before the visit means no surprise at the desk.",
    required: false,
