...
export const COMPONENT_HEX_EXCEPTIONS: readonly ComponentHexException[] = [
  ...
  },
  {
    ...
    sites: 6,
    rationale:
      "O220/O222: the ONE copy of the app-icon art (both icon routes call in), Satori-rendered at build like the OG image, whose rationale applies verbatim. Five gradient stops mirror the --hero-* band tokens and the glyph mirrors --on-ground; the dedup halved the register's declared icon sites from 12 to 6.",
  },
  {
    file: "app/layout.tsx",
    sites: 1,
