...
/**
 * Every one of the 49 specs that do not import `e2e/site-routes.ts`, as measured 2026-08-23.
...
export const SPEC_TRIAGE: readonly SpecTriage[] = [
  ...
  { file: "join-form.spec.ts", category: "single-route-feature", routes: ["/clinicians/join"], reason: "single public feature under test." },
  { file: "join-hero.spec.ts", category: "single-route-feature", routes: ["/clinicians/join"], reason: "single public feature under test." },
