...
| Team (`app/about`) | O90 | 2, 3 | The founders chapter as its own page, reached from the footer's About us door. Supplied portraits and self-declared roles and affiliations only; the h1 is the one word the founder specified; no clinical content |
