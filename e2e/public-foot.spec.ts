...
const NO_FOOTER: Readonly<Record<string, string>> = {
  ...
  "/approach": "O239: an app tab, not a document — three learning modules on the app's shell with the tab bar as the way onward, the same shape as /profile. Its own last control is the pill back to the finder.",
