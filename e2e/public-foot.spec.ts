...
const NO_FOOTER: Readonly<Record<string, string>> = {
  "/finder": "A tool, not a document. It runs a full-screen stage machine with its own controls — a fixed booking bar, the interface-launch corner control, and a back affordance on every stage — and a site footer under a live flow would be chrome competing with the task. The reader's way out is the launch control, which e2e/network.spec.ts already pins.",
