...
const pairs=[['reference-meditation.png','meditation-player-390.png','A shared moment of stillness','A dedicated session composition, live shared clock, optional chimes and written guidance. No invented participants or human host.'],['reference-learning.png','play-adhd-1440.png','Learning through discovery','Colourful lesson interiors, revealable ideas and response animation.'],['reference-learning.png','play-everyday-1440.png','Build the next small step','A sequence activity with feedback, ordered slots and reset.'],['reference-learning.png','meditation-lobby-1440.png','A different composition for a different moment','A scenic meditation lobby, personal duration controls and a scheduled session invitation.']];
